...
remote_state {
  ...
  config = {
    ...
    key    = "cloudflare/myscholastic-nonprod/myaccount-qa/page_rules"
    region = "us-east-1"
  }
}
...
inputs = {
  ...
  page_rule = [
    {
      target = "https://*myaccounts-qa.scholastic.com/*"
      actions = {
        ssl                  = "full"
        host_header_override = "d22cc48xs22wm9.cloudfront.net"
