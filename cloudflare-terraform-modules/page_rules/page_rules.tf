  ...
  dynamic "actions" {
    ...
    content {
      ...
      dynamic "cache_ttl_by_status" {
        for_each = can(var.page_rule[count.index].actions.cache_ttl_by_status) ? var.page_rule[count.index].actions.cache_ttl_by_status : []
        content {
          codes = can(cache_ttl_by_status.value.codes) ? cache_ttl_by_status.value.codes : null
          ttl   = can(cache_ttl_by_status.value.ttl) ? cache_ttl_by_status.value.ttl : null
        }
      }
