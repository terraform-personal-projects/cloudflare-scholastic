...
remote_state {
  ...
  config = {
    ...
    key    = "cloudflare/classmags-nonprod/mybigworld-aem-perf/page_rules"
    region = "us-east-1"
  }
}
...
inputs = {
  ...
  creds = {
    ...
    account_id = "bc3d029fdfc5d277b36c8f980620adad"
  },
  page_rule = [
    {
    ...
    {
      target = "https://*mybigworld-aem-perf.scholastic.com/*.pdf"
      actions = {
        cache_level = "bypass"
      },
      priority = 18
