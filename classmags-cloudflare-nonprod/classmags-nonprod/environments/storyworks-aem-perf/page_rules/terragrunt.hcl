...
remote_state {
  ...
  config = {
    ...
    key    = "cloudflare/classmags-nonprod/storyworks-aem-perf/page_rules"
    region = "us-east-1"
  }
}
...
inputs = {
  ...
  page_rule = [
      ...
      
    {
      ...
      actions = {
        ssl = "full"
        host_header_override = "storyworks-aem-perf.scholastic.com"
      },
      priority = 17
      status = "active"
      zone_id = "9b9f1ec179c9dde4857df0a0bdee9f8e"
    ...
    {
      target = "https://*storyworks-aem-perf.scholastic.com/*.pdf"
      actions = {
        cache_level = "bypass"
      },
      priority = 18
