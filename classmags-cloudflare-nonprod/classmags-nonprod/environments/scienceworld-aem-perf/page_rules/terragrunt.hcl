...
remote_state {
  ...
  config = {
    ...
    key    = "cloudflare/classmags-nonprod/scienceworld-aem-perf/page_rules"
    region = "us-east-1"
  }
}
...
inputs = {
  ...
  creds = {
    ...
    account_id = "6eae54d490c5bb039fad4f8ad9bf1308"
  },
  page_rule = [
    {
    ...
    {
      target = "https://*scienceworld-aem-perf.scholastic.com/*.pdf"
      actions = {
        cache_level = "bypass"
      },
      priority = 19
